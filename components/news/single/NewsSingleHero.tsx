...
const NewsSingleHero: FC<NewsSingleHeroProps> = ({ title, type, heroImage, publishedAt, lng }) => {
  ...
  return (
    <HawkStarsSection padding='none'>
      ...
      <div className='bg-green px-4 pt-10 pb-10 xl:px-40'>
        <div className='mx-auto max-w-4xl'>
          <span className='mb-4 inline-block rounded-lg border border-white px-3 py-1 text-xs font-bold tracking-widest text-white uppercase'>
            {type.replace('_', ' ')}
          </span>
        ...
        <div className='relative mt-5 h-48 w-auto max-w-4xl max-lg:mx-4'>
          <Image
            src={heroImage.url || ''}
            alt={heroImage.alt || ''}
            fill
