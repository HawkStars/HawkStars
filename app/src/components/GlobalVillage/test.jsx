            ...
            <div className="flex flex-col items-stretch w-[48%] max-md:w-full max-md:ml-0">
              <div className="items-stretch flex flex-col my-auto max-md:max-w-full max-md:mt-10">
                ...
                <div className="text-black text-2xl font-light leading-7 mt-4 max-md:max-w-full">
                  ...
                  distrito da Guarda, em Portugal, nascerá um projeto visionário
                  e futurista que promete não apenas redefinir a paisagem
                  urbana, mas contribuir para o desenvolvimento do cenário sócio
                  económico da cidadee da região em que está inserido.
                </div>
              </div>
            </div>
