...
export const CURRENT_PARTNERS = [
  ...
  },
  {
    ...
    description: `A Hawk Stars NGO para a Educação, Inovação e Desenvolvimento Social estabeleceu uma nova parceria com a Associação Juvenil Guarda a Terra 

    A parceria tem por base a colaboração em atividades de ambas as associações e a colaboração específica em atividades internacionais da Hawk Stars como o Programa Erasmus.`,
    contacts: [
  ...
  },
  {
    ...
    Recentemente a Hawk Stars esteve também envolvida na organização do Encontro Nacional de Estudos Europeus, que decorreu no Fundão.
