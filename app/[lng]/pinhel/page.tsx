...
import pinhelImage from '@/public/images/pinhel/descobrir-pinhel-3.webp';
...
const PinhelPage = async ({ params: { lng } }: LanguagePageProps) => {
  ...
  const mapPinhel =
    pinhelUrls[lng]?.historical_center ||
    pinhelUrls['pt'].historical_center ||
    '#';
  ...
  return (
    <section className='layout-section mt-5 flex flex-col gap-10'>
      ...
      <div className='mx-auto'>
        <Image src={pinhelImage} alt='Pinhel Image' className='rounded-sm' />
      </div>
    </section>
  );
};
