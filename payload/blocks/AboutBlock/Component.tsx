...
export const AboutBlock: React.FC<AboutBlockProps> = ({ title, description, image, sectionId }) => {
  const imageData = getImagePayloadUrl(image);

  return (
    <section className='mx-auto py-16 sm:py-20 md:py-24 lg:py-32' id={sectionId || ''}>
      {/* Hero Section */}
